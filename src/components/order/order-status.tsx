    ...
    <SectionWrapper>
      <div className="flex items-center gap-8 xl:gap-16">
        ...
        <div className="space-x-2">
          <span className="px-4 py-2 text-lg bg-Primary/80 text-white rounded-md ">in process</span>
      ...
      <p className="grid gap-4 text-xl text-Dark_grayish_blue text-center xl:text-2xl">
        ...
        <b className="text-3xl uppercase text-Primary xl:text-4xl"> chitrakala </b>
        <span>
