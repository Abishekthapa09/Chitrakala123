...
export const Footer = () => {
  return (
    ...
    <div className="mx-12 py-10 text-center md:text-left">
      <div className="w-full grid gap-8 ml-24 md:grid-cols-2 lg:grid-cols-3 p-18">
        ...
        <Button href="/">
          ...
          <p className=" pt-6">
            Chitrakala is the E-Commerce painting selling store at the cheaper price.
          </p>
        </div>
         <div className=" sm:mx-auto p-18 justify-center">
          <h6
            className="mb-4 flex justify-center font-semibold uppercase md:justify-start">
            Categories
          </h6>
          <p className="mb-4">
            <a href={'Category'} className="text-Primary "
              >Abstract</a>
          </p>
          <p className="mb-4">
            <a href={'Category'} className="text-Primary "
    ...
    <div className="text-Primary p-20 text-center ">
