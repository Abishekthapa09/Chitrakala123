...
export const ActionModal = ({
  ...
  if (variants === 'clear_cart') {
    ...
    bodyText = (
      <>
        You're about to <b className="text-Primary">delete all</b> items in your cart, Are you sure
        ?
      </>
    );
  }
  ...
  if (variants === 'delete_order') {
    ...
    bodyText = (
      <>
        You're about to <b className="text-Primary">delete</b> this currently active order, Are you
        sure ?
      </>
    );
  }
